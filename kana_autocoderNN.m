...
feat1 = encode(kana_autoenc1,xTrainImages);
...
hiddenSize2 = 50;
kana_autoenc2 = trainAutoencoder(feat1,hiddenSize2, ...
    'MaxEpochs',100, ...
...
feat2 = encode(kana_autoenc2,feat1);
...
kana_softnet = trainSoftmaxLayer(feat2,tTrain,'MaxEpochs',400);
